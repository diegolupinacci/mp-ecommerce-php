            ...
            <div style="border-top: solid;">
                <table>
                    <tr>
                        ...
                        <th>ID del sitio</th>
                        <th>Modo de procesamiento</th>
                        <th>ID del Vendedor</th>
                    </tr>
                    <tr>
                        <th><?php echo $_GET['collection_id'] ?></th>
                        <th><?php echo $_GET['collection_status'] ?></th>
                        <th><?php echo $_GET['external_reference'] ?></th>
                        <th><?php echo $_GET['payment_type'] ?></th>
                        <th><?php echo $_GET['preference_id'] ?></th>
                        <th><?php echo $_GET['site_id'] ?></th>
                        <th><?php echo $_GET['processing_mode'] ?></th>
                        <th><?php echo $_GET['merchant_account_id'] ?></th>
                    </tr>
                </table>
                <style>
                    table, th, td {
